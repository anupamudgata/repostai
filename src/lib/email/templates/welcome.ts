...
<div class="step"><div class="step-num">3</div><div><p class="step-title">Save hours every week</p><p class="step-desc">Your free plan includes unlimited repurposes (with a small watermark). Upgrade to Pro for $19/mo to remove it and unlock all platforms.</p></div></div>

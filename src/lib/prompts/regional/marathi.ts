...
export const MARATHI_CONFIG: RegionalLanguageConfig = {
  ...
  commonNativeWords: "करणे, होणे, शिकणे, खूप, पण, कारण, आनंद, वेळ, काम, आयुष्य, मी, तुम्ही, आम्ही, सगळ्यात, आधी, नंतर, आत्ता, यार, मित्रा, भाऊ",
  scriptExamples: {
    correct: [
...
1) CULTURAL REFERENCES (use when contextually appropriate):
   ...
   - Festivals: Ganpati Bappa, Gudhi Padwa energy, Diwali planning, पंढरपूर वारी
   - Entertainment: Marathi web series references, Sachin-Tendulkar pride, Pu La Deshpande wit

...
const FEATURES = [
  "Repurpose content to 10+ platforms",
  "AI-powered tone & style matching",
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left brand panel */}
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-violet-600 via-primary to-indigo-700 p-12 flex-col justify-between">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 -left-16 w-80 h-80 rounded-full bg-white/5 blur-3xl" />
          <div className="absolute bottom-1/3 -right-16 w-80 h-80 rounded-full bg-white/5 blur-3xl" />

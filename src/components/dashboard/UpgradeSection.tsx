...
const UPGRADE_PLANS = [
  {
    ...
    bg: "#F0FDFA",
    border: "#99F6E4",
    description: "50 repurposes · All platforms · No watermark",
  },
  {
    ...
    border: "#BFDBFE",
    popular: true,
    description: "150 repurposes · Claude Haiku AI · 5 brand voices",
  },
  {
    ...
    bg: "#F5F3FF",
    border: "#DDD6FE",
    description: "500 repurposes · Claude Sonnet · 15 brand voices",
  },
] as const;

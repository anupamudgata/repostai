...
export function WorkspaceHeader({
  ...
  function RepurposeGenerateButton({ className }: { className?: string }) {
    return (
      <Button
        size="lg"
        className={className}
  ...
  return (
    <>
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-border/50 pb-6">
        ...
        <div className="flex flex-col gap-3 sm:items-end shrink-0 w-full sm:w-auto">
          ...
          <RepurposeGenerateButton
            className={cn(
              "btn-generate w-full sm:w-auto min-h-12 font-semibold border-0 px-6",
      ...
      >
        <RepurposeGenerateButton className="btn-generate w-full min-h-12 font-semibold border-0 px-6" />
      </div>
    </>
  );
}
